...
- Unterstützung bei der Einrichtung von Netzwerkkomponenten  
- Mitarbeit bei administrativen IT-Aufgaben  

Diese Erfahrungen haben mein Interesse an IT-Infrastruktur und Systemintegration weiter gestärkt.

## 📚 Aktuelle Lerninhalte
Im Rahmen meiner Umschulung lerne ich derzeit:
- Windows-Administration  
- Netzwerktechnik (TCP/IP, Routing)  
- Programmierung mit Python und C  
- Grundlagen in HTML/CSS  

Zusätzlich vertiefe ich mein Wissen durch praktische Übungen auf Plattformen wie TryHackMe.
...
## 🗂️ Über dieses Repository
Dieses Repository dient als mein persönliches Lernportfolio.  
Hier dokumentiere ich meine Fortschritte, Notizen und Übungen im Bereich Netzwerktechnik und IT.

## 🚀 Lernfortschritt
Ich entwickle meine Fähigkeiten Schritt für Schritt weiter und nutze dieses Repository, um meinen Lernweg sichtbar zu machen.
...
⭐ Vielen Dank fürs Anschauen meines Profils!
